    ...
    <div className="flex flex-col h-full w-full sm:w-60 bg-stone-800 border-r border-stone-700 overflow-hidden">
      ...
      <div className="px-3 py-3 border-b border-stone-700 shrink-0">
        <div className="flex items-center justify-between mb-2">
          <p className="text-xs font-semibold text-stone-500 uppercase tracking-wider">Historial</p>
          <button
            onClick={onClose}
            aria-label="Cerrar historial"
            className="p-1 rounded-md text-stone-500 hover:text-stone-300 hover:bg-stone-700 transition-colors"
          >
